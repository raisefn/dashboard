...
const capabilities: { label: string; oneliner: string; status: Status; audience: string; color: string }[] = [
  ...
  // Planned
  { label: "Gmail Draft Compose", oneliner: "raise(fn) drafts your outreach, opens in Gmail with everything filled — you review and send", status: "planned", audience: "founders", color: "#f87171" },
  ...
  { label: "Investor Behavior", oneliner: "How investors actually behave — from real raise data", status: "planned", audience: "investors", color: "#f97316" },
